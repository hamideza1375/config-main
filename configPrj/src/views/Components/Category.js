...
//     category.remove('64b00db5301acd6480754274')
//     category.find("64b0530c57a2eb21a26483af").title = 3333333444
//     category.changeIndex(10).title = 'newTitle'
...
//         data={p.category?.value() ? p.category.value() : []}
